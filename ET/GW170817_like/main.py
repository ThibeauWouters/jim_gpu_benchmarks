...
Mc_prior    = Uniform(1.0, 1.5, naming=['M_c'])
s1z_prior   = AlignedSpin(0.05, naming=['s1_z'])
s2z_prior   = AlignedSpin(0.05, naming=['s2_z'])
dL_prior    = Uniform(50, 500, naming=['d_L'])
